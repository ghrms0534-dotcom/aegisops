...
const Deployments = () => {
  ...
  return (
    <div className="space-y-6">
      <div><h3 className="text-xl font-semibold text-white">Operations</h3><p className="mt-1 text-sm text-brand-muted">Deployment, Rollback, Release History와 Health Verification을 추적합니다.</p></div>
